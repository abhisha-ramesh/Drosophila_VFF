...
peak_val_multiplier = 10        #multiplier for the myosin profile
...
Time = 13*t_relax  #+ (20*t_relax)              Total time 
#
...
lambda_link_apical_peripheral = 20                   #strength of peripheral apical-core links(peripheral sub-apical stiffness)
...
def configure_simulation():
    ...
    contact.ElementCC3D("Energy", {"Type1": "basal_prime", "Type2": "basal_prime"}, 10)
    ...
    contactIn.ElementCC3D("Energy", {"Type1": "basal", "Type2": "core"}, 100.0)
    contactIn.ElementCC3D("Energy", {"Type1": "apical", "Type2": "basal"}, 100.0)
    contactIn.ElementCC3D("Energy", {"Type1": "apical", "Type2": "core"}, 2.0)
    contactIn.ElementCC3D("Energy", {"Type1": "basal_prime", "Type2": "core_prime"}, 100.0)
...
from GastrulationSteppables import *
